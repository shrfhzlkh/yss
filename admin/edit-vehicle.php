			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kemaskini Kenderaan</h2>
...
<div class="col-sm-10">
<textarea class="form-control" name="vehicaloverview" rows="3" required><?php echo htmlentities($result->VehiclesOverview);?></textarea>
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">No Plat<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="platenumber" class="form-control" value="<?php echo htmlentities($result->PlateNumber);?>" required>
</div>
<label class="col-sm-2 control-label">Pilih Jenis Minyak<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="inlineCheckbox1"> Penghawa Dingin </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Kemaskini</button>
<a href="manage-vehicles.php" class="btn btn-danger" style="margin-top:4%">Batal</a><br><br>
												</div>
											</div>
