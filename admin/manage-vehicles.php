			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kenderaan</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Butiran Kenderaan</div>
...
<?php $sql = "SELECT tblvehicles.VehiclesTitle,tblvehicles.FuelType,tblvehicles.PlateNumber,tblvehicles.ModelYear,tblvehicles.id from tblvehicles";
$query = $dbh -> prepare($sql);
$query->execute();
