			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Kemaskini Maklumat</h2>
...
{				?>	
				...
				<div class="form-group">
											...
											<div class="form-group">
												<label class="col-sm-4 control-label"> Alamat Emel</label>
												<div class="col-sm-8">
													<input type="email" class="form-control" name="email" id="email" value="<?php echo htmlentities($result->EmailId);?>" required>
												</div>
											</div>
<div class="form-group">
												<label class="col-sm-4 control-label"> Nombor Telefon </label>
												<div class="col-sm-8">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Kemaskini</button>
												</div>
											</div>
