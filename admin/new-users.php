...
$sql="INSERT INTO  tblusers(FullName,Position,EmailId,ContactNo,Password,Image) VALUES(:fname,:position,:email,:mobile,:password,:image)";
...
if($lastInsertId)
{
echo "<script>alert('Registration successful. The user has been added.');</script>";
}
else 
{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Pengguna Baru</h2>
            ...
            <div class="col-md-12 col-sm-6">
              <form  method="post" name="signup" onSubmit="return valid();" enctype="multipart/form-data">
                ...
                <div class="col-sm-2 col-sm-offset-5">
                  <div class="pb-5">
                  <button type="submit" value="Sign Up" name="signup" id="submit" class="btn btn-block">Selesai</button><br><br><br>
                  </div>
                </div>
                </div>
              </form>
