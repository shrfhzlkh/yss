...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,Position=:position where EmailId=:email";
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_20">
      <div class="upload_user_logo"> <img src="admin/img/user/<?php echo htmlentities($result->Image);?>" alt="image" style="height:170px" class="imge">
      </div>

      <div class="dealer_info">
        <h5><?php echo htmlentities($result->FullName);?></h5>
        <b><?php echo htmlentities($result->Position);?></b><br>
          <?php echo htmlentities($result->EmailId);?><br>
          <?php echo htmlentities($result->ContactNo);?></p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Profil</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Kemaskini terakhir pada  -</label>
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" value="<?php echo htmlentities($result->Position);?>" name="position" id="position" type="text" >
            </div>
            <?php }} ?>
